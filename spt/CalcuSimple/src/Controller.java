...
public class Controller implements ActionListener, KeyListener
{
    ...
    public void actionPerformed(ActionEvent event)
    {
        try
        {
            if(event.getSource() == view.button_add) add();
            else if(event.getSource() == view.button_subtract) subtract();
            else if(event.getSource() == view.button_multiply) multiply();
            else if(event.getSource() == view.button_divide) divide();
        }
